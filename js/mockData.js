...
window.EroiMockData = {
  ...
  regolamenti: {
    studente: [
      ...
      { id: "s2", titolo: "Limiti di Sessione (Salute e Benessere)", testo: "Lo studente ha a disposizione un tempo di gioco attivo di 45 minuti per sessione. Al termine, dovrà effettuare una pausa obbligatoria di 15 minuti. È consentito giocare al massimo 2 sessioni al giorno (per un totale di 90 minuti). Superato il limite, l'accesso sarà bloccato per 24 ore per evitare un'eccessiva esposizione allo schermo." },
      { id: "s3", titolo: "Guadagno di Dracme e XP", testo: "Ottieni Dracme ed XP completando attività quotidiane, risolvendo quiz e partecipando ai Minigiochi." },
      { id: "s4", titolo: "Il Diario di Bordo e Note al Testo", testo: "Nei nodi abilitati, potrai scrivere il tuo 'Diario di Bordo'. I docenti valuteranno il tuo diario per assegnarti ricompense speciali. Le note al testo approfondiscono gli elementi narrativi e arricchiscono il tuo background." },
